...
import image1 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo7.png';
import image2 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo8.png';
import image3 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo9.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionVariablesOperacionesCEjercicio2').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
