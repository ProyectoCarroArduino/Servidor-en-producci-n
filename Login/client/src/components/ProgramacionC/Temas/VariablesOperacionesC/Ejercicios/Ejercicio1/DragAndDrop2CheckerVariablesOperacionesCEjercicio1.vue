<template>
  ...
  export default {
    ...
    data() {
      return {
        ordenCorrecto: [
          { id: 1, text: "int dividendo, divisor;" },
          { id: 2, text: "int cociente, residuo;" },
          { id: 3, text: "cociente = dividendo / divisor;" },
          { id: 4, text: "residuo = dividendo % divisor;" },
          { id: 5, text: "printf(mensaje, cociente);" },
          { id: 6, text: "printf(mensaje, residuo);" },
          { id: 7, text: "return 0;" },
    ...
    setup() {
      ...
      const [todoList, todos] = useDragAndDrop(
        [
          ...
          { id: 2, text: "cociente = dividendo / divisor;"},
          { id: 3, text: "int cociente, residuo;"},
          { id: 4, text: "printf(mensaje)"},
          { id: 5, text: "int area = 6;"},
          { id: 6, text: "printf(mensaje, cociente);"},
      ...
      const [doneList, dones] = useDragAndDrop(
        [
          { id: 7, text: "int dividendo, divisor;"},
          { id: 8, text: "return 0;"},
          { id: 9, text: "printf(mensaje, residuo);"},
          { id: 10, text: "residuo = dividendo % divisor;"},
          { id: 11, text: "int area;"},
        ],
        {
          plugins: [animations()],
  ...
  .gray-background2 {
    background-color: hwb(268 6% 14% / 0.863); /* Fondo gris claro */
  }
