...
import image1 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo4.png';
import image2 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo5.png';
import image3 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionVariablesOperacionesCEjercicio1').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
