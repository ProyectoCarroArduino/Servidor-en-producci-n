...
import image1 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo10.png';
import image2 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo11.png';
import image3 from '@/assets/ImagenesVariablesOperacionesC/Algoritmo12.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionVariablesOperacionesCEjercicio3').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
