<template>
    <div>
      <h4 class="texto-personalizado">De acuerdo a la teoria sobre la instrucción switch case, seleccione los elementos necesarios que se necesitan para construir la estructura de la instrucción switch case:</h4>
      <p><span style="font-weight: bold;">Nota:</span> <strong>No se debe</strong> incluir los bloques de instrucción y los break.</p>
      <p class="texto-personalizado"><strong>Instrucciones:</strong> los <strong>Elementos</strong> deben ir en el cuadro a la derecha de color <strong>rosado</strong> y el orden debe ser descendente.</p>
      <br>
  ...
  export default {
    ...
    data() {
      return {
        ordenCorrecto: [
          { id: 1, text: "switch (opcion) {" },
          { id: 2, text: "case 1:" },
          { id: 3, text: "resultado = num1 + num2;" },
          { id: 4, text: "case 2:" },
          { id: 5, text: "resultado = num1 - num2;" },
          { id: 6, text: "case 3:" },
          { id: 7, text: "resultado = num1 * num2;" },
          { id: 8, text: "case 4:" },
          { id: 9, text: "resultado = num1 / num2;" },
          { id: 10, text: "default:" },
          { id: 11, text: "}" },
    ...
    setup() {
      ...
      const [doneList, dones] = useDragAndDrop(
        [
          ...
          { id: 8, text: "case 2:"},
          { id: 9, text: "case 3:"},
          { id: 10, text: "resultado = num1 + num2;"},
          { id: 11, text: "case 4:"},
          { id: 12, text: "resultado = num1 / num2;"},
  ...
  .kanban-item {
    padding: 0.5rem;
    background-color: rgba(61, 228, 125, 0.904);
  ...
  .gray-background2 {
    background-color: hwb(303 14% 11% / 0.863); /* Fondo gris claro */
  }
