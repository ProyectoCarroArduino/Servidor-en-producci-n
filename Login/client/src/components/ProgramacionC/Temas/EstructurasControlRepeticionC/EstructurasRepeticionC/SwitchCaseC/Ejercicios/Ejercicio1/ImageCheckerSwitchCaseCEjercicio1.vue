...
import image1 from '@/assets/ImagenesSwitchCaseC/Algoritmo4.png';
import image2 from '@/assets/ImagenesSwitchCaseC/Algoritmo5.png';
import image3 from '@/assets/ImagenesSwitchCaseC/Algoritmo6.png';
import image4 from '@/assets/ImagenesSwitchCaseC/Algoritmo7.png';
import image5 from '@/assets/ImagenesSwitchCaseC/Algoritmo8.png';
import image6 from '@/assets/ImagenesSwitchCaseC/Algoritmo9.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionSwitchCaseCEjercicio1').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
