  ...
  export default {
    ...
    methods: {
      verificarOrden() {
        ...
        const ordenEsperado = ["case 4:", "bloque de instrucción: if (num2 != 0)", "bloque de instrucción: else", "break;"];
    ...
    setup() {
      const [parent, tapes] = useDragAndDrop(
        [
          "case 4:",
          "bloque de instrucción: if (num2 != 0)",
          "break;",
          "bloque de instrucción: else",
...
.space-x-4 > * + * {
  ...
  .bg-blue {
    background-color: hsla(303, 87%, 55%, 0.705);
  }
