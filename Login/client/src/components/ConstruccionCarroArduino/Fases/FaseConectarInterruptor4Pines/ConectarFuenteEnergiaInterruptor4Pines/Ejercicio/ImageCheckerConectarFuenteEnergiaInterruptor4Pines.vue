...
import image1 from '@/assets/ImagenesConectarFuenteEnergiaInterruptor4Pines/Algoritmo1.png';
import image2 from '@/assets/ImagenesConectarFuenteEnergiaInterruptor4Pines/Algoritmo2.png';
import image3 from '@/assets/ImagenesConectarFuenteEnergiaInterruptor4Pines/Algoritmo3.png';
import image4 from '@/assets/ImagenesConectarFuenteEnergiaInterruptor4Pines/Algoritmo4.png';
import image5 from '@/assets/ImagenesConectarFuenteEnergiaInterruptor4Pines/Algoritmo5.png';
import image6 from '@/assets/ImagenesConectarFuenteEnergiaInterruptor4Pines/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstractionConectarFuenteEnergiaInterruptor4Pines').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
