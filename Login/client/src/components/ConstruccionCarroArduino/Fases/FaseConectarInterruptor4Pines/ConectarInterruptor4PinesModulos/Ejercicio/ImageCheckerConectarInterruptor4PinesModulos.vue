...
import image1 from '@/assets/ImagenesConectarInterruptor4PinesModulos/Algoritmo1.png';
import image2 from '@/assets/ImagenesConectarInterruptor4PinesModulos/Algoritmo2.png';
import image3 from '@/assets/ImagenesConectarInterruptor4PinesModulos/Algoritmo3.png';
import image4 from '@/assets/ImagenesConectarInterruptor4PinesModulos/Algoritmo4.png';
import image5 from '@/assets/ImagenesConectarInterruptor4PinesModulos/Algoritmo5.png';
import image6 from '@/assets/ImagenesConectarInterruptor4PinesModulos/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionConectarInterruptor4PinesModulos').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
