...
import audio5 from '@/assets/AudiosMontarArduinoUNOSoporte/Audio3.mp3';
import audio6 from '@/assets/AudiosMontarArduinoUNOSoporte/Audio3.mp3';
  ...
  methods: {
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/ConectarInterruptor4PinesModulosTeoria').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
