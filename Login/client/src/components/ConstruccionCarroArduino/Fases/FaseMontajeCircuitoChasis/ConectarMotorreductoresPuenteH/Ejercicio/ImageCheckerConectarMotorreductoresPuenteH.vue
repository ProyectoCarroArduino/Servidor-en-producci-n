...
import image1 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Algoritmo1.png';
import image2 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Algoritmo2.png';
import image3 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Algoritmo3.png';
import image4 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Algoritmo4.png';
import image5 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Algoritmo5.png';
import image6 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionConectarMotorreductoresPuenteH').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
