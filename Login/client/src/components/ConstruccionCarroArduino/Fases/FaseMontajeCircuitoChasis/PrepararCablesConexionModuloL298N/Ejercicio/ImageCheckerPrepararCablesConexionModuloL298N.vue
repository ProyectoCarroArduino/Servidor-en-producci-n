...
import image1 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Algoritmo1.png';
import image2 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Algoritmo2.png';
import image3 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Algoritmo3.png';
import image4 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Algoritmo4.png';
import image5 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Algoritmo5.png';
import image6 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionPrepararCablesConexionModuloL298N').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
