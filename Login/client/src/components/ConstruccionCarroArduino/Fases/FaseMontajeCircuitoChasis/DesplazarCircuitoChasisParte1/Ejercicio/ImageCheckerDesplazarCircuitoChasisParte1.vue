...
import image1 from '@/assets/ImagenesDesplazarCircuitoChasisParte1/Algoritmo1.png';
import image2 from '@/assets/ImagenesDesplazarCircuitoChasisParte1/Algoritmo2.png';
import image3 from '@/assets/ImagenesDesplazarCircuitoChasisParte1/Algoritmo3.png';
import image4 from '@/assets/ImagenesDesplazarCircuitoChasisParte1/Algoritmo4.png';
import image5 from '@/assets/ImagenesDesplazarCircuitoChasisParte1/Algoritmo5.png';
import image6 from '@/assets/ImagenesDesplazarCircuitoChasisParte1/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionDesplazarCircuitoChasisParte1').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
