...
import image1 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo1.png';
import image2 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo2.png';
import image3 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo3.png';
import image4 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo4.png';
import image5 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo5.png';
import image6 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo6.png';
import image7 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo7.png';
import image8 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo8.png';
import image9 from '@/assets/ImagenesEnsamblarMotorreductoresSoportes/Algoritmo9.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionEnsamblarMotorreductoresSoportes').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
...
.image-item img {
  ...
  border-radius: 5px 5px 0 0;
   ...
   .image-item p {
  position: static; /* o simplemente elimina esta línea */
  margin-top: 5px;
  text-align: center;
  font-weight: bold;
  color: rgb(27, 27, 27);
  background-color: transparent; /* o un color que no tape */
  border-radius: 0;
  margin-bottom: 0;
  padding: 0;
}
