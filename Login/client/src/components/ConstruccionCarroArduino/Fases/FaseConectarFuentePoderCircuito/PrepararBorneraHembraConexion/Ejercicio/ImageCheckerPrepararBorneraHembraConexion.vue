...
import image1 from '@/assets/ImagenesPrepararBorneraHembraConexion/Algoritmo1.png';
import image2 from '@/assets/ImagenesPrepararBorneraHembraConexion/Algoritmo2.png';
import image3 from '@/assets/ImagenesPrepararBorneraHembraConexion/Algoritmo3.png';
import image4 from '@/assets/ImagenesPrepararBorneraHembraConexion/Algoritmo4.png';
import image5 from '@/assets/ImagenesPrepararBorneraHembraConexion/Algoritmo5.png';
import image6 from '@/assets/ImagenesPrepararBorneraHembraConexion/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionPrepararBorneraHembraConexion').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
