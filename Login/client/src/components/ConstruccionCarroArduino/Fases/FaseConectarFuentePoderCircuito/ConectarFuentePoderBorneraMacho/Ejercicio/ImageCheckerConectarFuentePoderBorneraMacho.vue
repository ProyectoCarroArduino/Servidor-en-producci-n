...
import image1 from '@/assets/ImagenesConectarFuentePoderBorneraMacho/Algoritmo1.png';
import image2 from '@/assets/ImagenesConectarFuentePoderBorneraMacho/Algoritmo2.png';
import image3 from '@/assets/ImagenesConectarFuentePoderBorneraMacho/Algoritmo3.png';
import image4 from '@/assets/ImagenesConectarFuentePoderBorneraMacho/Algoritmo4.png';
import image5 from '@/assets/ImagenesConectarFuentePoderBorneraMacho/Algoritmo5.png';
import image6 from '@/assets/ImagenesConectarFuentePoderBorneraMacho/Algoritmo6.png';
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionConectarFuentePoderBorneraMacho').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
