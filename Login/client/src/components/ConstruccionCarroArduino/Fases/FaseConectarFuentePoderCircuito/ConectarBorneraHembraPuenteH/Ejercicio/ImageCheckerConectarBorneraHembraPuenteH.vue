...
import image1 from '@/assets/ImagenesConectarBorneraHembraPuenteH/Algoritmo1.png';
import image2 from '@/assets/ImagenesConectarBorneraHembraPuenteH/Algoritmo2.png';
import image3 from '@/assets/ImagenesConectarBorneraHembraPuenteH/Algoritmo3.png';
import image4 from '@/assets/ImagenesConectarBorneraHembraPuenteH/Algoritmo4.png';
import image5 from '@/assets/ImagenesConectarBorneraHembraPuenteH/Algoritmo5.png';
import image6 from '@/assets/ImagenesConectarBorneraHembraPuenteH/Algoritmo6.png';
  ...
  setup() {
    ...
    const evaluacionAlgorithmRaw = reactive(
      useEvaluacionSubejercicio({
        ...
        submodulo: '3.3 Conectar bornera hembra al puente H (módulo L298N):',
  ...
  this.showPrincipal = false;
    ...
    finish() {
      if (this.isFinishEnabled) {
        ...
        router.push('/AbstraccionConectarBorneraHembraPuenteH').then(() => {
          window.scrollTo(0, 0);
        });
      }
    }
