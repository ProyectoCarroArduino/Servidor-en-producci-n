<template>
  <div>
    ...
    <p v-if="intentosRestantes > 0 && ordenCorrecto !== true" class="contador">
    ...
    <p v-if="intentos5 > 0 && ordenCorrecto2 !== true" class="contador">
