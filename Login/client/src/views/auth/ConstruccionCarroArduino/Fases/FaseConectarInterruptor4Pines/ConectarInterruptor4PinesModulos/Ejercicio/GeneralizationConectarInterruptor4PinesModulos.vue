<template>
    <div id="layout-general">
      ...
      <hr class="my-4" />
            ...
            <br>
            <p class="texto-personalizado">Teniendo en cuenta las <strong>didácticas</strong> anteriores generalice el paso a paso de la definición de las funciones <strong>(energiaArduinoUNO y energiaModuloL298N)</strong>:</p>
            <br>
            <img class="centrada" src="@/assets/ImagenesConectarInterruptor4PinesModulos/CodigoGeneralizacion.png" alt="CodigoGeneralizacion">
            <br>
...
<script>
import AudioChecker from "@/components/ConstruccionCarroArduino/Fases/FaseConectarInterruptor4Pines/ConectarInterruptor4PinesModulos/Ejercicio/AudioCheckerConectarInterruptor4PinesModulos.vue";
