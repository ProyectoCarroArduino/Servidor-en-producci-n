<template>
    <div id="layout-general">
      ...
      <hr class="my-4" />
            ...
            <br>
            <p class="texto-personalizado">Teniendo en cuenta las <strong>didácticas</strong> anteriores generalice el paso a paso de la definición de la función <strong>(interruptor4Pines)</strong>:</p>
            <br>
            <img class="centrada" src="@/assets/ImagenesConectarFuenteEnergiaInterruptor4Pines/CodigoGeneralizacion.png" alt="CodigoGeneralizacion">
            <br>
...
<script>
import AudioChecker from "@/components/ConstruccionCarroArduino/Fases/FaseConectarInterruptor4Pines/ConectarFuenteEnergiaInterruptor4Pines/Ejercicio/AudioCheckerConectarFuenteEnergiaInterruptor4Pines.vue";
