...
<script>
import ImageChecker from "@/components/ConstruccionCarroArduino/Fases/FaseConectarFuentePoderCircuito/PrepararBorneraHembraConexion/Ejercicio/ImageCheckerPrepararBorneraHembraConexion.vue";
