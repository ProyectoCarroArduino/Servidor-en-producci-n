...
<script>
import ImageChecker from "@/components/ConstruccionCarroArduino/Fases/FaseMontajeCircuitoChasis/ConectarMotorreductoresPuenteH/Ejercicio/ImageCheckerConectarMotorreductoresPuenteH.vue";
