<template>
    <div id="layout-general">
      ...
      <hr class="my-4" />
            ...
            <br>
            <p class="texto-personalizado">Teniendo en cuenta las <strong>didácticas</strong> anteriores generalice el paso a paso de la definición de la función <strong>(main)</strong>:</p>
            <br>
            <img class="centrada" src="@/assets/ImagenesConectarMotorreductoresPuenteH/CodigoGeneralizacion1.png" alt="CodigoGeneralizacion1">
            <br>
            <img class="centrada" src="@/assets/ImagenesConectarMotorreductoresPuenteH/CodigoGeneralizacion2.png" alt="CodigoGeneralizacion2">
            <br>
...
<script>
import AudioChecker from "@/components/ConstruccionCarroArduino/Fases/FaseMontajeCircuitoChasis/ConectarMotorreductoresPuenteH/Ejercicio/AudioCheckerConectarMotorreductoresPuenteH.vue";
