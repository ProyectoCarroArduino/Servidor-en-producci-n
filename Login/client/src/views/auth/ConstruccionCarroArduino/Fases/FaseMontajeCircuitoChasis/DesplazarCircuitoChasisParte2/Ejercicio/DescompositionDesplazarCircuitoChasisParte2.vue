<template>
  <div id="layout-general">
    <main class="contenido">
      <h1 class="text-center">Paso 4. Desplazar circuito al chasis parte 2</h1>
      <br>
      <br>
      <h2>Ejercicio:</h2>
      <br>
      <p class="texto-personalizado">Se necesita un programa en C que simule el proceso de ordenar los siguientes componentes: 1. Módulo bluetooth HC-06, 2. Placa Arduino UNO, 3. Módulo L298N (puente H), 4. Salir. 
        Es importante tener en cuenta que el <strong>orden correcto de los componentes debe ser</strong>:</p>
      <ul>
          <li><p class="texto-personalizado"> <strong>1: Placa Arduino UNO.</strong></p></li>
          <li><p class="texto-personalizado"> <strong>2: Módulo bluetooth HC-06.</strong></p></li>
          <li><p class="texto-personalizado"> <strong>3. Bornera tipo hembra.</strong></p></li>
          <li><p class="texto-personalizado"> <strong>0. Salir.</strong></p></li>
      </ul>
      ...
      <ul>
          ...
          <li><p class="texto-personalizado"> <strong>Implementar una validación que verifique que el orden de los componentes sea el siguiente: 1. Placa Arduino UNO, 2. Módulo bluetooth HC-06, 3. Salir.</strong></p></li>
      ...
      <p class="texto-personalizado">Selecciona el video que muestra el proceso de ubicación (pegar) la placa Arduino UNO:</p>
      <br>
      <p style="padding-left: 20px;"><span style="font-weight: bold;">Nota:</span> El video del proceso <strong>solo debe contener</strong> la parte en la cual se ubica (pega) la placa Arduino UNO.</p>
      <br>  
      ...
      <p class="texto-personalizado">Selecciona la imagen correcta que muestra la simulación hecha en Fritzing de la ubicación de la placa Arduino UNO:</p>
      <br>
...
import Funcion5 from '@/assets/ImagenesDesplazarCircuitoChasisParte2/Simulacion1.png';
import Funcion6 from '@/assets/ImagenesDesplazarCircuitoChasisParte2/Simulacion2.png';
import Funcion7 from '@/assets/ImagenesDesplazarCircuitoChasisParte2/Simulacion3.png';
import Funcion8 from '@/assets/ImagenesDesplazarCircuitoChasisParte2/Simulacion4.png';
...
setup() {
  ...
  const evaluacionImagenRaw = reactive(useEvaluacionSubejercicio({
    ...
    submodulo: '4.4 Desplazar circuito al chasis parte 2:',
  ...
  return {
    ...
    data() {
      return {
        ...
        videos: [
          { src: "https://www.youtube.com/embed/M1CeFuM92vI?si=2mIbaf-IYieIIw6H", alt: 'Video 1' },
          { src: "https://www.youtube.com/embed/MGXgMQzhqrU?si=XyN9XfBdXErFKn4z", alt: 'Video 2' },
          { src: "https://www.youtube.com/embed/8nzZcIo38SA?si=IAWWBLmTXsxq8T5C", alt: 'Video 3' },
        ].sort(() => Math.random() - 0.5),
...
,
  ...
  if (this.selectedVideo.src === "https://www.youtube.com/embed/M1CeFuM92vI?si=2mIbaf-IYieIIw6H") {
  ...
  async finish() {
    ...
    this.$router.push('/AlgoritmoDesplazarCircuitoChasisParte2').then(() => {
      window.scrollTo(0, 0);
    });
  }
  }
