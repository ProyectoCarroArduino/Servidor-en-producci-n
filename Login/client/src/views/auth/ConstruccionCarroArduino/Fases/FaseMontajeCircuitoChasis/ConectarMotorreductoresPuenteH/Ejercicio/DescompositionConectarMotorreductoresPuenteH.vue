<template>
  <div id="layout-general">
    <main class="contenido">
      ...
      <p class="texto-personalizado">Selecciona el video que muestra el proceso de conexión de los cables de los motorreductores al módulo L298N:</p>
      <br>
      <p style="padding-left: 20px;"><span style="font-weight: bold;">Nota:</span> El video del proceso <strong>no solo debe contener</strong> la parte en la se introducen los cables a los pines, también debe contener el momento en el que se ajustan los pines con el destornillador pequeño.</p>
      <br>  
      ...
      <p class="texto-personalizado">Selecciona la imagen correcta que muestra la simulación hecha en Fritzing de la conexiones de los cables de los motorredcutores a los pines OUT del módulo L298N (puente H):</p>
      <br>
      <p style="padding-left: 20px;"><span style="font-weight: bold;">Nota:</span> La imagen correcta <strong>realiza</strong> las conexiones de los cables a los pines (OUT) del módulo L298N (puente H) de la misma forma que se menciona en la teoria.</p>
      <br>
      <br>
      <div class="figuras">
        <div
...
import Funcion5 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Simulacion1.png';
import Funcion6 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Simulacion2.png';
import Funcion7 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Simulacion3.png';
import Funcion8 from '@/assets/ImagenesConectarMotorreductoresPuenteH/Simulacion4.png';
  ...
  return {
    ...
    data() {
      return {
        ...
        videos: [
          { src: "https://www.youtube.com/embed/4u8TCN9PdjY?si=bbccP720lHTGK0TY", alt: 'Video 1' },
          { src: "https://www.youtube.com/embed/xCid-tNqjnk?si=PHokrhthCR4VgjuV", alt: 'Video 2' },
          { src: "https://www.youtube.com/embed/sBcbETou-SA?si=q-BU8V0RJFwSbS-G", alt: 'Video 3' },
        ].sort(() => Math.random() - 0.5),
...
,
  ...
  if (this.selectedVideo.src === "https://www.youtube.com/embed/4u8TCN9PdjY?si=bbccP720lHTGK0TY") {
  ...
  async finish() {
    ...
    this.$router.push('/AlgoritmoConectarMotorreductoresPuenteH').then(() => {
      window.scrollTo(0, 0);
    });
  }
  }
