<template>
  <div id="layout-general">
    <main class="contenido">
      ...
      <p class="texto-personalizado">Selecciona el video que muestra el proceso de soldadura de los cables de los motorredcutores:</p>
      <br>
      <p style="padding-left: 20px;"><span style="font-weight: bold;">Nota:</span> El video del proceso <strong>solo debe contener</strong> la parte en la cual se están soldando los cables.</p>
      <br>  
      ...
      <p class="texto-personalizado">Selecciona la imagen correcta que muestra la simulación hecha en Fritzing del resultado final de la preparación de los cables de los motorreductores:</p>
      <br>
      <p style="padding-left: 20px;"><span style="font-weight: bold;">Nota:</span> La imagen correcta es <strong>similar</strong> al esquema de los cables de los motorredcutores.</p>
      <br>
      <br>
      <div class="figuras">
        <div
...
import Funcion5 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Simulacion1.png';
import Funcion6 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Simulacion2.png';
import Funcion7 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Simulacion3.png';
import Funcion8 from '@/assets/ImagenesPrepararCablesConexionModuloL298N/Simulacion4.png';
  ...
  return {
    ...
    data() {
      return {
        ...
        videos: [
          { src: "https://www.youtube.com/embed/mxCBiZf_yWk?si=ixqf0YNxubVUFA5M", alt: 'Video 1' },
          { src: "https://www.youtube.com/embed/s90spkx2w4A?si=igRInT9cypZORc43", alt: 'Video 2' },
          { src: "https://www.youtube.com/embed/Z2585oTZu-w?si=ULRenWcvDbQs42WV", alt: 'Video 3' },
        ].sort(() => Math.random() - 0.5),
...
,
  ...
  if (this.selectedVideo.src === "https://www.youtube.com/embed/mxCBiZf_yWk?si=ixqf0YNxubVUFA5M") {
