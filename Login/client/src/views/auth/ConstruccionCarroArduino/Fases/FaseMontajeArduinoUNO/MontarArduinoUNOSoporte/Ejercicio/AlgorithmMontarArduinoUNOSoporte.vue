...
<script>
import ImageChecker from "@/components/ConstruccionCarroArduino/Fases/FaseMontajeArduinoUNO/MontarArduinoUNOSoporte/ImageCheckerMontarArduinoUNOSoporte.vue";
