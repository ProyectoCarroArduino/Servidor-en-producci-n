<template>
  <div id="layout-general">
    <main class="contenido">
      ...
      <p class="texto-personalizado">Selecciona el video que muestra el montaje de la placa Arduino UNO al soporte:</p>
      <br>
      ...
      <p class="texto-personalizado">Selecciona la imagen correcta que muestra la simulación hecha en Fritzing de la placa Arduino UNO:</p>
      <br>
      <p style="padding-left: 20px;"><span style="font-weight: bold;">Nota:</span> La imagen correcta es <strong>similar</strong> al componente mostrado en los materiales necesarios para realizar este paso.</p>
      <br>
      <br>
      <div class="figuras">
        <div
...
import Funcion5 from '@/assets/ImagenesMontarArduinoUNOSoporte/ArduinoUNO1.png';
import Funcion6 from '@/assets/ImagenesMontarArduinoUNOSoporte/ArduinoUNO2.png';
import Funcion7 from '@/assets/ImagenesMontarArduinoUNOSoporte/ArduinoUNO3.png';
import Funcion8 from '@/assets/ImagenesMontarArduinoUNOSoporte/ArduinoUNO4.png';
  ...
  return {
    ...
    data() {
      return {
        ...
        videos: [
          { src: "https://www.youtube.com/embed/He4uEzRf01A?si=g0JNbgGokYr0fhTq", alt: 'Video 1' },
          { src: "https://www.youtube.com/embed/lu9iyrTQjrU?si=F54PGKhC9uax8PoX", alt: 'Video 2' },
          { src: "https://www.youtube.com/embed/GJHHEZt7fiE?si=cebaBc2kzeNirLaA", alt: 'Video 3' },
        ].sort(() => Math.random() - 0.5),
