...
<script>
import ImageChecker from "@/components/ConstruccionCarroArduino/Fases/FaseEnsamblaje/EnsamblarMotorreductoresSoportes/Ejercicio/ImageCheckerEnsamblarMotorreductoresSoportes.vue";
