<template>
    <div id="layout-general">
        ...
        <ul>
            ...
            <br>
            <img class="centrada" src="@/assets/ImagenesEnsamblarRuedasMotorreductores/CodigoGeneralizacion.png" alt="CodigoGeneralizacion">
            <br>
...
<script>
import AudioChecker from "@/components/ConstruccionCarroArduino/Fases/FaseEnsamblaje/EnsamblarRuedasMotorreductores/Ejercicio/AudioCheckerEnsamblarRuedasMotorreductores.vue";
