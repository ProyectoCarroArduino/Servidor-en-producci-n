<template>
  <div id="user">
    <div class="card card-body mt-8 align-left col-md-15">
      ...
      <p class="texto-personalizado">Selecciona la imagen correcta que muestra la conexión de los cables rojo y negro al motorreductor en el simulador TinkerCAD:</p>
      <br>
      <div class="figuras">
        <div
...
import Funcion5 from '@/assets/ImagenesConectarCablesMotorreductores/Motorreductor1.png';
import Funcion6 from '@/assets/ImagenesConectarCablesMotorreductores/Motorreductor2.png';
import Funcion7 from '@/assets/ImagenesConectarCablesMotorreductores/Motorreductor3.png';
import Funcion8 from '@/assets/ImagenesConectarCablesMotorreductores/Motorreductor4.png';
