...
<script>
import AudioChecker from "@/components/ConstruccionCarroArduino/Fases/FaseEnsamblaje/ConectarCablesMotorreductores/Ejercicio/AudioCheckerConectarCablesMotorreductores.vue";
