  ...
  return {
    ...
    data() {
      return {
        ...
        videos: [
          { src: "https://www.youtube.com/embed/ZLfHJ2C2_-w?si=NAHfcHm7gTuah2Z6", alt: 'Video 1' },
          { src: "https://www.youtube.com/embed/IytFbPXyy3M?si=ch63BeItP_E4TjSe", alt: 'Video 2' },
          { src: "https://www.youtube.com/embed/RH3XL7tXTjQ?si=gTxaoBPmK0VegnIK", alt: 'Video 3' },
        ].sort(() => Math.random() - 0.5),
