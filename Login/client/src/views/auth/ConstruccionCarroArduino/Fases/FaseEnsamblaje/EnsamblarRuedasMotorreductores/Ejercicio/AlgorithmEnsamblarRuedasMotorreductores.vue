...
<script>
import ImageChecker from "@/components/ConstruccionCarroArduino/Fases/FaseEnsamblaje/EnsamblarRuedasMotorreductores/Ejercicio/ImageCheckerEnsamblarRuedasMotorreductores.vue";
