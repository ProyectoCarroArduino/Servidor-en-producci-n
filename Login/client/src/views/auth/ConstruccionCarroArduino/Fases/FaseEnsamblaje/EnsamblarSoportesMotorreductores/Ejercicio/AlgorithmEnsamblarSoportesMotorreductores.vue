...
<script>
import ImageChecker from "@/components/ConstruccionCarroArduino/Fases/FaseEnsamblaje/EnsamblarSoportesMotorreductores/Ejercicio/ImageCheckerEnsamblarSoportesMotorreductores.vue";
