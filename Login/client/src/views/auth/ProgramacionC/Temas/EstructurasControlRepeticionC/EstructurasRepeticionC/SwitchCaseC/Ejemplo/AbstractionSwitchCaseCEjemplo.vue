...
int main() {
    ...
    printf("Digite un número entre 1 y 2: ");
    scanf("%d", &opcion);

    switch (opcion) {
        case 1:
            printf("Ha seleccionado la opción número 1\n");
            break;
        case 2:
            printf("Ha seleccionado la opción número 2\n");
            break;
        default:
            printf("El número seleccionado no se encuentra en las opciones\n");
            break;
    }
  ...
  methods: {
    ...
    finish() {
      ...
      router.push('/GeneralizacionSwitchCaseCEjemplo').then(() => {
        window.scrollTo(0, 0);
      });
    }
  }
