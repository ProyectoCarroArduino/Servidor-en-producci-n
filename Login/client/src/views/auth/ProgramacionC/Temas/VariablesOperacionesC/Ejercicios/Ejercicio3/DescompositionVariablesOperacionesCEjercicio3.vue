<template>
  <div id="layout-general">
    <main class="contenido">
      ...
      <h3>Ejercicio 3:</h3>
      <br>
      <p class="texto-personalizado">Hacer un programa en C que calcule <strong>la distancia en línea recta entre dos puntos</strong> en un plano cartesiano.
      Las cordenadas de los puntos son las siguientes:</p>
      <ul>
        <li><strong>Punto A: (3,5)</strong></li>
        <li><strong>Punto B: (-1,3)</strong></li>
      </ul>
      <p><span style="font-weight: bold;">Nota:</span> El programa deberá solictar al usuario que ingerese las coordenadas <strong>(solo usar varibles de tipo float)</strong>.</p>
      <p><span style="font-weight: bold;">Nota2:</span> <strong>Se debe</strong> usar el comando especial <strong>(sqrt)</strong>, pero <strong>no se debe usar</strong> el comando espeial <strong>(pow)</strong>.</p>
      <br>
      <hr class="my-4" />
      <br>
...
import DragAndDrop1Checker from "@/components/ProgramacionC/Temas/VariablesOperacionesC/Ejercicios/Ejercicio3/DragAndDrop1CheckerVariablesOperacionesCEjercicio3.vue";
import DragAndDrop2Checker from "@/components/ProgramacionC/Temas/VariablesOperacionesC/Ejercicios/Ejercicio3/DragAndDrop2CheckerVariablesOperacionesCEjercicio3.vue";
import Figura1 from '@/assets/ImagenesVariablesOperacionesC/Codigo25.png';
import Figura2 from '@/assets/ImagenesVariablesOperacionesC/Codigo26.png';
import Figura3 from '@/assets/ImagenesVariablesOperacionesC/Codigo27.png';
import Figura4 from '@/assets/ImagenesVariablesOperacionesC/Codigo28.png';
import Figura5 from '@/assets/ImagenesVariablesOperacionesC/Codigo29.png';
import Figura6 from '@/assets/ImagenesVariablesOperacionesC/Codigo30.png';
import Figura7 from '@/assets/ImagenesVariablesOperacionesC/Codigo31.png';
import Figura8 from '@/assets/ImagenesVariablesOperacionesC/Codigo32.png';
...
export default {
  ...
  methods: {
    ...
    finish() {
      router.push('/AlgoritmoVariablesOperacionesCEjercicio3').then(() => {
        window.scrollTo(0, 0);
      });
    },
